<%-- 
    Document   : carrinho
    Created on : 04/05/2020, 20:52:11
    Author     : Ochaus
--%>
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <table class="table shopping-summery">
                        ...
                        <tbody>
                            <c:forEach items="${ProdutoCarrinho}" var="c" end="5">
                            <tr>
                                <td class="image" data-title="No"><img src="imagens/${c.img}.jpg" alt="#"></td>
                                <td class="product-des" data-title="Description">
                                    <p class="product-name"><a href="#">${c.nome}</a></p>
                                </td>
                                <td class="price" data-title="Price"><span>${c.valor} </span></td>
