<%-- 
    Document   : cadastroWeb
    Created on : 14/04/2020, 15:33:18
    Author     : Ochaus
--%>
                                ...
                                <div class="row">
                                    <div class="col-lg-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input name="nome" id="nome" type="text" placeholder="Ex: João ">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input name="sobrenome" id="sobrenome" type="text" placeholder="Ex: Silva ">
                                        </div>
                                    </div>
