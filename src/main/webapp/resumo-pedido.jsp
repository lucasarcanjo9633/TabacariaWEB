<%-- 
    Document   : resumo-pedido
    Created on : 19/06/2020, 11:00:48
    Author     : Ochaus
--%>
                    ...
                    <div>
                        <div class="row">                       
                            <div class="col-lg-4 col-md-7 col-12">
                                <div>
                                    <ul>                                       
                                        <li>CEP: <span>${sessionScope.itensSelecionados.endereco.CEP}</span></li>
                                        <li>Endereço: <span>${sessionScope.itensSelecionados.endereco.endereco}</span></li>                                        
                                        <li>Bairro: <span>${sessionScope.itensSelecionados.endereco.bairro}</span></li>
                                        <li>Cidade: <span>${sessionScope.itensSelecionados.endereco.cidade}</span></li>
                                        <li>Estado: <span>${sessionScope.itensSelecionados.endereco.UF}</span></li>
                                    </ul>                               
                                </div>
                            </div>
                        </div>
                    ...
                    <div>
                        <div class="row">                       
                            <div class="col-lg-4 col-md-7 col-12">
                                <div>
                                    <ul>                                     
                                        <li>Total a pagar: <span>R$ ${sessionScope.itensSelecionados.precoFinal}</span></li>
                                        <li>Forma de Pagamento: <span>${sessionScope.itensSelecionados.pagamento}</span></li>
                                    </ul>                               
                                </div>
                            </div>
                        </div>
                ...
                <div class="single-widget get-button">
                    <div class="content">
                        <div class="button">
                            ...
                            <input type="hidden" name="acao" value="salvarVenda">
